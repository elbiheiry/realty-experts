            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form class="ajax-form" method="post" action="{{route('admin.testimonials')}}"
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" name="position_ar">
                            </div>
                            <div class="col-sm-6 form-group">
                    ...
                    <div class="table-responsive">
                        <table id="datatableX" class="table table-hover table-bordered display nowrap" cellspacing="0"
                            ...
                            @foreach($testimonials as $index => $testimonial)
                                <tr class="ticket-tr">
                                    <td>{{$index+1}}</td>
                                    <td>{{$testimonial->translate('en')->name}}</td>
                                    <td>{{$testimonial->created_at}}</td>
                                    <td>
                                        <button data-url="{{route('admin.testimonials.edit',['id' => $testimonial->id])}}"
