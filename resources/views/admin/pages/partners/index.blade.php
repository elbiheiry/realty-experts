            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form class="ajax-form" method="post" action="{{route('admin.partners')}}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group img-block">
                                    ...
                                    <div class="text-danger text-center">Image size should be: 127 * 97</div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table id="datatableX" class="table table-hover table-bordered display nowrap" cellspacing="0"
                            ...
                            @foreach($partners as $index => $partner)
                                <tr class="ticket-tr">
                                    <td>{{$index+1}}</td>
                                    <td><img src="{{asset('storage/app/partners/'.$partner->image)}}" width="97"></td>
                                    <td>{{$partner->created_at}}</td>
                                    <td>
                                        <button data-url="{{route('admin.partners.edit',['id' => $partner->id])}}"
