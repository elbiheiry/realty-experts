                    ...
                    <div class="table-responsive">
                        <table id="datatableX" class="table table-hover table-bordered display nowrap" cellspacing="0"
                            ...
                            @foreach($members as $index => $member)
                                <tr class="ticket-tr">
                                    <td>{{$index+1}}</td>
                                    <td>{{$member->translate('en')->name}}</td>
                                    <td>{{$member->created_at}}</td>
                                    <td>
                                        <a href="{{route('admin.links',['id' => $member->id])}}"
                                                class="icon-btn blue-bc" title="links">
                                            <i class="fa fa-link"></i>
                                        </a>
                                        <button data-url="{{route('admin.members.edit',['id' => $member->id])}}"
